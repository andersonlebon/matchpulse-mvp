...
import { Sparkles, ChevronRight, Star, TrendingUp, User, MessageSquare, BarChart2, Loader2, Zap } from 'lucide-react';
import { MATCHES, getMatchesByStatus } from '../data/matches';
        ...
        {tab === 'ai' && (
          <div className="flex flex-col gap-4">
            ...
            >
              ...
              <p className="text-sm text-foreground leading-relaxed">{recap.aiInsight}</p>
            </div>
            ...
            <div className="p-4 rounded-xl bg-secondary border border-border">
              <p className="text-xs text-muted-foreground flex items-start gap-2">
                ...
                AI recaps are generated by MatchPulse's analysis engine using match data, event streams, and tactical databases.
                Full live AI analysis will be available once the real-time data integration is complete.
              </p>
            </div>
          </div>
        )}
